...
public struct Colors {
    static func colorOfDefault(_ name: String, alpha: CGFloat = 1.0) -> UIColor {
        return PlaniAssets.colorFromName(name, alpha: alpha) ?? UIColor.black
    }
    ...
    public static var purple200: Color {
        return Color(colorOfDefault("purple200"))
    }
    
    /// Returns color with rgb #4664E6
    public static var purple300: Color {
        return Color(colorOfDefault("purple300"))
    }
    ...
    public static var orange100: Color {
        return Color(colorOfDefault("orange100"))
    }
    
    /// Returns color with rgb #F5B941
    public static var orange300: Color {
        return Color(colorOfDefault("orange300"))
    }
